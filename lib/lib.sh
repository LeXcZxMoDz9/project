...
# download URLs
export PANEL_DL_URL="https://github.com/LeXcZxMoDz9/anying/raw/refs/heads/main/panel.zip"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/LeXcZxMoDz9/project"}
...
welcome() {
  ...
  output ""
  output "Copyright (C) 2023 - 2024, LeXcZ, <lexcz@lexcz.xyz>"
  output "https://github.com/LeXcZxMoDz9/project"
  output ""
